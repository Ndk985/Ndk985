...
### Разработчик веб-приложений и REST API на Django, FastAPI и Flask

[![Telegram](https://img.shields.io/badge/Telegram-@Ndk985-blue?logo=telegram)](https://t.me/Ndk985)
[![GitHub](https://img.shields.io/badge/GitHub-Ndk985-black?logo=github)](https://github.com/Ndk985)
[![Email](https://img.shields.io/badge/Email-ndk985%40gmail.com-D14836?logo=gmail&logoColor=white)](mailto:ndk985@gmail.com)
...
### **🤖 Cuckoo Pump — тренажёр для собеседований** 
*Flask, SQLAlchemy, Telegram Bot API, CI/CD*
> Веб-приложение с админ-панелью, JSON API, сессионными квизами и Telegram-ботом. Полноценный CI/CD с автоматическим деплоем и резервным копированием БД.

### **❤️ Благотворительный фонд QRKot** 
*FastAPI, async SQLAlchemy, Google Sheets API*
> REST API для управления благотворительными проектами с автоматическим распределением пожертвований. Интеграция с Google Sheets для автоматической генерации отчетов по закрытым проектам.
...
- **📐 Архитектура REST API:** Проектирование понятных, масштабируемых API с правильной структурой эндпоинтов, пагинацией, фильтрацией и версионированием
- **🔐 Безопасность и авторизация:** Реализация JWT аутентификации, ролевых моделей доступа, проверок прав и защита от основных уязвимостей
- **⚡ Асинхронность и производительность:** Использование async/await в FastAPI, оптимизация запросов к БД, кеширование в Redis, фоновые задачи через Celery
